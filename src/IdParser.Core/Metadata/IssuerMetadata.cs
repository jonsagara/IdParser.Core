...
internal static class IssuerMetadataHelper
{
    ...
    /// </summary>
    internal static string GetAbbreviationOrDefault(this IssuerIdentificationNumber issuerIdentificationNumber)
    ...
    /// </summary>
    internal static Country GetCountry(this IssuerIdentificationNumber issuerIdentificationNumber)
    {
    ...
    /// use the enum value as a string.
    /// </summary>
    internal static string GetDescriptionOrDefault(this IssuerIdentificationNumber issuerIdentificationNumber)
