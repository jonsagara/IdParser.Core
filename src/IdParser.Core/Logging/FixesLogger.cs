...
internal static partial class FixesLogger
{
    ...
    internal static partial void InputDoesntStartWithExpectedComplianceIndicator(this ILogger logger, char expectedComplianceIndicator, string methodName);
    ...
    internal static partial void ForcefullyEnsuringValidHeader(this ILogger logger, string expectedFileType);
    ...
    internal static partial void ReplacingOldAAMVAHeaderWithCurrentValidHeader(this ILogger logger);
    ...
    internal static partial void FixingMalformedHeader(this ILogger logger);

    [LoggerMessage(EventId = 104, Level = LogLevel.Information, Message = "Scanned text contains \\r characters. Removing them.")]
    internal static partial void TextContainsCarriageReturns(this ILogger logger);

    [LoggerMessage(EventId = 105, Level = LogLevel.Information, Message = "Adding the single allowed \\r character back to the header.")]
    internal static partial void AddingRequiredCarriageReturnToHeader(this ILogger logger);
}
