...
internal static partial class BarcodeLogger
{
    ...
    internal static partial void PopulateIdCardUnhandledException(ILogger logger, Exception ex, string methodName, string elementId);
    ...
    internal static partial void UnhandledElementIds(ILogger logger, string unhandledElementIds);
}
