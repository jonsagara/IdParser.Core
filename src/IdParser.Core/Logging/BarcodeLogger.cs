...
internal static partial class BarcodeLogger
{
    ...
    internal static partial void PopulateIdCardUnhandledException(this ILogger logger, Exception ex, string methodName, string elementId);
    ...
    internal static partial void UnhandledElementIds(this ILogger logger, string unhandledElementIds);
}
