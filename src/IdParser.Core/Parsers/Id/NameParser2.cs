...
internal record NameParts2(string? First, string? Middle, string? Last, string? Suffix);

internal static class NameParser2
{
    ...
    // AAMVA 2000
    internal static NameParts2? Parse2(string elementId, string? rawValue)
    {
    ...
    /// </summary>
    private static NameParts2 ParseWithStandardSeparators(string input)
    {
        ...
        return new NameParts2(First: first, Middle: middle, Last: last, Suffix: suffix);
    }

    /// <summary>
    /// Parses names separated by non-standard space separators (e.g. JOHN Q PUBLIC)
    /// </summary>
    private static NameParts2 ParseWithSpaceSeparator(string input)
    {
