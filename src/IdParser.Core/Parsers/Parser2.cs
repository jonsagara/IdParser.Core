...
{
    internal static bool ParseAndSetIdElements(string elementId, string data, Country country, AAMVAVersion version, IdentificationCard2 idCard)
    {
        ...
        switch (elementId)
        {
            ...
            case SubfileElementIds.DateOfBirth:
                idCard.DateOfBirth = DateOfBirthParser.Parse2(elementId: elementId, input: data, country, version);
                break;
    ...
    internal static bool ParseAndSetDriversLicenseElements(string elementId, string data, Country country, AAMVAVersion version, DriversLicense2 driversLicense)
    {
        ArgumentNullException.ThrowIfNull(elementId);
        ArgumentNullException.ThrowIfNull(data);
