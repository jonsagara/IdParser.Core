...
public class DriversLicenseTests : BaseTest
{
    ...
    public void TestMA2009License()
    {
        ...
        var (idCard, _) = Barcode.Parse(file, Validation.None, _output);
    ...
    public void TestNYLicense()
    {
        ...
        var file = License("NY");
        var (idCard, _) = Barcode.Parse(file);

        AssertIdCard(expected, idCard);
        AssertLicense(expected, idCard);

        Assert.Equal("New York", idCard.IssuerIdentificationNumber.GetDescriptionOrDefault());
    }
    ...
    public void TestFLLicense()
    {
        var expected = new DriversLicense
        {
            ...
            Sex = Sex.Male,
            Height = new Height(feet: 6, inches: 1),
    ...
    public void TestSCLicense()
    {
        var expected = new DriversLicense
        {
            ...
            Sex = Sex.Female,
            Height = new Height(feet: 5, inches: 10),
            Weight = new Weight(pounds: 128),
